...
(function () {
  const L = {
    zh: {
      ...
      // 连接设置
      connSettings: "连接设置",
      setServerAddrPh: "server_addr (如 gw.example:9499)",
      setAdminAddrPh: "admin_addr (如 gw.example:9444)",
      setServerCAPh: "server_ca (CA 文件路径, 空=系统根)",
      setListenHostPh: "listen_host (默认 127.0.0.1)",
      setCertDirPh: "cert_dir (证书目录路径, 空=系统证书库)",
      saveSettings: "保存并热重载",
      settingsSaved: "已保存并热重载",
      settingsFailed: "保存失败: {e}",
    ...
    en: {
      ...
      setServerAddrPh: "server_addr (e.g. gw.example:9499)",
      setAdminAddrPh: "admin_addr (e.g. gw.example:9444)",
      setServerCAPh: "server_ca (CA file path, empty=system roots)",
      setListenHostPh: "listen_host (default 127.0.0.1)",
      setCertDirPh: "cert_dir (cert dir path, empty=system store)",
      saveSettings: "Save & hot reload",
      settingsSaved: "Saved (hot reloaded)",
      settingsFailed: "Save failed: {e}",
